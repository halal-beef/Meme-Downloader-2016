...
dotnet publish /home/runner/work/SharpBoot/Meme-Downloader-2016/wadpwodk.csproj --output build\ --arch x64 --os linux -c release --self-contained true # linux build
